...
class ApkTool(object):
    ...
    def decompile(apk):
        ...
        subprocess.check_call(['java', '-jar', APKTOOL, 'd', '-r', '-f', '-o', outdir, apk, '--only-main-classes'])
        return outdir
    ...
    def compile(decompiled_dir):
        ...
        subprocess.check_call(['java', '-jar', APKTOOL, 'b', '-o', unsiged_apk, decompiled_dir, '--only-main-classes'])
        return unsiged_apk
